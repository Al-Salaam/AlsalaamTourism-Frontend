  ...
  const filteredRows =
    ...
    bookings.filter((row) => {
      const isCategoryMatch =
        filterCategory === "All" || row.activity.itemType === filterCategory;
      const isStatusMatch =
        filterStatus === "All" || row.paymentStatus === filterStatus; // Corrected this line
          ...
          <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
            <TableHead>
              <TableRow sx={{ backgroundColor: "#FAFAFA" }}>
                ...
                <TableCell align="middle" sx={{ padding: 2 }}>
                  Date
                </TableCell>
                    ...
                    <>
                      {currentRows.map((row) => (
                        ...
                        >
                          ...
                          <TableCell align="middle" sx={{ padding: 4 }}>
                            {row.activity.itemType}
                          </TableCell>
                          <TableCell align="middle">{row.adults}</TableCell>
                          <TableCell align="middle" sx={{ color: "blue" }}>
                            {row.children}
                          </TableCell>
