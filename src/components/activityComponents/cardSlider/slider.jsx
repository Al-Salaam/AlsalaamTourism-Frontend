                    ...
                    <Col key={item?._id} xs={24} sm={24} md={12} lg={8} xl={8} xxl={8}>
                        <Card style={cardStyle}>
                            ...
                            <Row gutter={10} style={{marginTop:"30px"}}>
                                ...
                                <Col xs={8} sm={8} md={8} lg={8} xl={8}><Image src= {imog} style={{width:"55px",height:"55px", borderRadius:"100%",border:"2px solid #4FAEAB"}}/></Col>
                                <Col xs={8} sm={8} md={8} lg={8} xl={8}><Title level={4}> {item?.name}</Title></Col>
                                <Col xs={8} sm={8} md={8} lg={8} xl={8}><Rate allowHalf={true} disabled value={item?.rating} count={5} style={{color:"#4FAEAB"}}/></Col>
                            </Row>
                        </Card>
                    </Col>
                ))}
