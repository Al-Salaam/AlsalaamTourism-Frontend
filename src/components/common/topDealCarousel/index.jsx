...
const TopDealCarousel = () => (
  ...
  <Row xs={24} sm={24} md={24}  xl={24} lg={24} style={{}}>
  <Col xs={24} sm={24} md={24}  xl={24} lg={24} align="middle"><Title style={{ 
        color: "white",
        textShadow: "2px 2px 4px rgba(0, 0, 0, 0.7)"}}>TOP DEALS </Title></Col>
  </Row>
  <Carousel autoplay>
