        ...
        <Row gutter={16}>
            <Col xs={24} sm={12} md={12} lg={12} xl={12} xxl={12}>
                ...
                <div style={contentStyle1}>
                        <Image preview={false} src={Image1} alt='Al Salaam Tourism-about us 2' width={breakPoint1?"35vw":"27vw"} />
                        <Image preview={false} src={Image2} alt='Al Salaam Tourism-about us 3'  width={breakPoint1?"35vw":"27vw"} style={{marginTop:"-50%",marginLeft:"25%"}}/>
                </div>
